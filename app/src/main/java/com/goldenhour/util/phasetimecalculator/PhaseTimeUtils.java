...
/**
 * Utility class for phase time calculation
 */
public class PhaseTimeUtils {
    ...
    /*radian issue*/
    private double getSunTrueLongitude(boolean isSunrise) {
    ...
    * */
    private double getSunLocalHour(boolean isSunrise, Zenith zenith) {
        ...
        double cosH = (cos(convertDegreesToRadians(zenith.getDegrees())) -
                (sinDec * sin(convertDegreesToRadians(latitude)))) / (cosDec * cos(convertDegreesToRadians(latitude)));
        if (isSunrise) {
